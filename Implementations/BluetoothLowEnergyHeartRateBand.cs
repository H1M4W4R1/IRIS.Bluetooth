...
namespace IRIS.Bluetooth.Implementations
{
    ...
    public sealed class BluetoothLowEnergyHeartRateBand() : BluetoothLowEnergyDeviceBase(HEART_RATE_SERVICE_UUID)
    {
        ...
        /// </summary>
        /// <returns>A ValueTask representing the asynchronous configuration operation.</returns>
        ...
        /// </summary>
        /// <param name="heartRate">The heart rate measurement data containing the current heart rate and energy expenditure information.</param>
